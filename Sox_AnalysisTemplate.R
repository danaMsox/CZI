...
#fit is much better
#CFI=.924 and TLI=.908, CFI and TLI above 0.90 is accepted as good fit
#RMSEA=0.082 RMSEA values less than 0.08 is considered good fit
...
#SCHOOL CLIMATE VARIABLES ARE SIGNIFICANT-YAY! :)
#CFI=.932 and TLI=.916, CFI and TLI above 0.90 is accepted as good fit
#RMSEA=0.083 RMSEA values less than 0.08 is considered good fit
#SRMR=0.072 SRMR at 0.08 is considered good fit
...
psych::alpha(`Managing Disagreement and Understanding Identity` |> 
               mutate_if(is.factor,as.numeric))
#0.92 Cronbach's alpha and item-total correlations are all above 0.3. (r.drop=0.50-0.74)

#Supporting Themselves and Others
psych::alpha(`Supporting Themselves and Others`|> 
               mutate_if(is.factor,as.numeric))
...
>>>>>>> 3b17209c980824319d041872f1e3991d668942b3
